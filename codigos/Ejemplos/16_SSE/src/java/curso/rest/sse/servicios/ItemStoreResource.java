...
public class ItemStoreResource {
    ...
    static {
        broadcaster.add(new BroadcasterListener<OutboundEvent>() {
            ...
            public void onException(ChunkedOutput<OutboundEvent> chunkedOutput, Exception exception) {
                LOGGER.log(Level.WARNING, "An exception has been thrown while broadcasting to an event output.", exception);
            }
     ...
     * client connection.
     * @throws InternalServerErrorException in case replaying missed events to
     * the reconnected output stream fails.
     * @throws ServiceUnavailableException in case the reconnect delay is set to
     * a positive value.
     */
    @GET
    @Path("events")
